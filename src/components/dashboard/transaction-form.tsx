    ...
    <GlassCard>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        ...
        <input
          ...
          placeholder={t("price")}
          aria-label={t("price")}
          className="w-full rounded-lg border border-border-subtle bg-background px-3 py-2 text-sm outline-none transition-shadow focus:border-foreground-muted focus:ring-1 focus:ring-white/10 placeholder:text-foreground-muted md:col-span-2"
        />
